...
let RATE_THBC_PER_USDT = 35; // default; will update from contract
...
// ✅ Unlimited Approve + fixed gas for Bitget
async function approveUSDT() {
  ...
  try {
    ...
    const needReapprove = web3.utils
      ...
      .lt(web3.utils.toBN("1000000000000000000")); // < 1 USDT
    ...
    await usdtContract.methods
      ...
      .send({
        ...
        gas: 200000, // force gas limit for Bitget
      });
...
async function buyTHBC() {
  ...
  try {
    ...
    if (
      ...
      refToUse = null; // prevent self-ref
    }
